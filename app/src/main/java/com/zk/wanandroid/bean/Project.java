...
public class Project {
    ...
    public static class DatasBean {
         ...
         * collect : false
         * courseId : 13
         * desc : 音频播放器，基础播放功能有：播放，暂停，下一首，上一首；可以设置多种播放类型：顺序播放，随机播放，单曲循环；可以设置播放进度快慢，参考混沌大学APP；支持后台播放，可以扫描本地音频，有效处理了捕获/丢弃音频焦点逻辑，支持耳机线控。通知栏，底部音频播放控制栏，音频List页面和播放详情页数据同步。持续更新中……

         * envelopePic : http://www.wanandroid.com/blogimgs/c7f7b36e-ef55-4a24-b2b9-d10fa7697470.png
         * id : 2465
         * link : http://www.wanandroid.com/blog/show/2076
         * niceDate : 3小时前
         * origin :
         * projectLink : https://github.com/yangchong211/YCAudioPlayer
         * publishTime : 1520734260000
         * title : 开源音乐播放器  YCAudioPlayer
         * visible : 0
         * zan : 0
         */
